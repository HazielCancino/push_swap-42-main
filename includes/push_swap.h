...
# include "../libft/gnl/includes/get_next_line_bonus.h"
...
void					handle_big_error(t_stack *a, t_stack *b,
...
void					calculate_best_moves(t_stack *a, t_stack *b,
...
void					apply_best_moves(t_stack *a, t_stack *b,
							t_best_moves *bm);
// ===============================================================
...
void					ft_copy_best_move(t_best_moves *bm,
...
void					handle_error_instruct(t_instruct **linst, t_stack *a,
							t_stack *b);
void					ft_lstclear_instruct(t_instruct **lst,
							void (*del)(char *));
// ===============================================================
